...
import { icons } from './icons/index.js'; // AJOUT IMPORTANT EN HAUT DU FICHIER

export const THEMES = {
  Chill: { base:"#040B16", b1:"#00F0FF", b2:"#0038FF", glow:"rgba(0,240,255,.5)", from:"#67e8f9", to:"#3b82f6", label:"Chill", icon: icons.chill },
  Spicy: { base:"#1A0505", b1:"#FF5C00", b2:"#FF003C", glow:"rgba(255,92,0,.5)", from:"#facc15", to:"#f97316", label:"Spicy", icon: icons.spicy },
  Hardcore: { base:"#0A0012", b1:"#9D00FF", b2:"#FF003C", glow:"rgba(157,0,255,.5)", from:"#e879f9", to:"#dc2626", label:"Hardcore", icon: icons.hardcore }
};

export const JOKERS = {
  SHIELD: { name: "Bouclier", icon: icons.shield, desc: "Mode intouchable. Zéro gorgée." },
  MIRROR: { name: "Miroir", icon: icons.mirror, desc: "C'est l'autre qui trinque." },
  DOUBLE: { name: "Double ou Rien", icon: icons.double, desc: "Grosse prise de risque (x2)." },
  SHOT: { name: "Cul sec", icon: icons.shot, desc: "Bim. Un cul sec cadeau." },
  THIEF: { name: "Voleur", icon: icons.thief, desc: "Pique un pouvoir en scred." }
};
